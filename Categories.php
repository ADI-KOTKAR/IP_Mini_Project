...
<head>
    ...
    <title>TechVents | Manage Categories</title>
...
<div class="mid">
    <div class="sidebar">
        ...
        <a class="active" href="Categories.php"><i class="fas fa-tags"></i> Categories</a>
...
<div class="topp">
    <div class="content">
        ...
        <form action="Categories.php" method="post">
            <fieldset>
                <h4>Name:</h4>
                <input type="text" name="Category" id="Name" placeholder="Name">
                <input type="Submit" name="Submit" id="add" value="Add New Category">
            </fieldset>
        </form>
        <table>
            <tr>
