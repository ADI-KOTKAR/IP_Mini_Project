...
<head>
    ...
    <title>TechVents | Admin Dashboard</title>
...
<div class="mid">
    <div class="sidebar">
        <a class="active" href="dashboard.php"><i class="fas fa-th"></i> Dashboard</a>
    ...
    <div class="content">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <button class="edit">
                        <a href="EditPost.php?Edit=<?php echo $Id; ?>">Edit</a>
                    </button>
                    <button class="del">
                        <a href="DeletePost.php?Delete=<?php echo $Id; ?>">Delete</a>
                    </button>
                </td>
                <td>
